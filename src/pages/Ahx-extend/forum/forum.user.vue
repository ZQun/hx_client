<template>
    <view class="tui-container">
        ...
        <tui-modal :show="cancelOrder" @click="cancelOrderOK" @cancel="cancelOrderOff" content="确定删除帖子吗？" color="#333" :size="32"></tui-modal>
    </view>
</template>
...
<script>
    ...
    export default {
        ...
        onShareAppMessage(res) {
            // 分享带分享者id
            let title = '慧享优选社区'
            let path = '/pages/Ahx-extend/forum/forum.user'
